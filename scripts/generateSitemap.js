...
// URLs estáticas
const staticUrls = [
  { loc: 'https://planivia.net/', priority: '1.0', changefreq: 'weekly', lastmod: '2026-01-01' },
  { loc: 'https://planivia.net/precios', priority: '0.9', changefreq: 'weekly', lastmod: '2026-01-01' },
  { loc: 'https://planivia.net/para-proveedores', priority: '0.9', changefreq: 'weekly', lastmod: '2026-01-01' },
  { loc: 'https://planivia.net/app', priority: '0.8', changefreq: 'weekly' },
  { loc: 'https://planivia.net/para-planners', priority: '0.8', changefreq: 'weekly' },
  { loc: 'https://planivia.net/gestion-invitados-boda', priority: '0.9', changefreq: 'weekly', lastmod: '2026-01-01' },
  { loc: 'https://planivia.net/presupuesto-boda-online', priority: '0.9', changefreq: 'weekly', lastmod: '2026-01-01' },
  { loc: 'https://planivia.net/seating-plan-boda', priority: '0.9', changefreq: 'weekly', lastmod: '2026-01-01' },
  { loc: 'https://planivia.net/blog', priority: '0.7', changefreq: 'daily' },
];
...
countries.forEach(country => {
  dynamicUrls.push({
    loc: `https://planivia.net/${country}`,
    priority: '0.8',
    changefreq: 'weekly',
    lastmod: '2026-01-01'
  });
...
Object.values(citiesData).forEach(city => {
  if (city.services) {
    Object.keys(city.services).forEach(serviceSlug => {
      ...
      dynamicUrls.push({
        loc: `https://planivia.net/${city.country}/${city.slug}/${serviceSlug}`,
...
const blogUrls = blogPosts.map(post => ({
  loc: `https://planivia.net/blog/${post.slug}`,
  priority: '0.7',
  changefreq: 'monthly',
