...
1. Ve a: https://github.com/Daniel-Navarro-Campos/mywed360/actions
...
```bash
curl https://api.github.com/repos/Daniel-Navarro-Campos/mywed360/actions/runs?branch=windows&per_page=5
```
