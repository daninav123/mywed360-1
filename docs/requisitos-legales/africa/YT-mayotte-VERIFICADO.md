...
**Fuente oficial primaria**: ⚠️ PENDIENTE  
**Autoridad competente**: Mairie (Town Hall) - Francia  

### 📌 Notas Importantes

**DATOS CONFIRMADOS (parcial):**
- Departamento de ultramar francés
- Legislación francesa aplica
- Matrimonio igualitario legal (Francia 2013)
...
### Autoridad
**⚠️ PENDIENTE DE VERIFICAR** - Mairie (esperado, legislación francesa)
