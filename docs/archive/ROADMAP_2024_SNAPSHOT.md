# Roadmap - MaLove.App (snapshot Diciembre 2024)

> ⚠️ Este archivo es un snapshot histórico. El roadmap canónico actual se genera desde `docs/flujos-especificos/` con `node scripts/aggregateRoadmap.js` y se publica en `docs/ROADMAP.md`.
...
- **[conclusion]** parcial
- **[implementado (doc)]**
  - `Tasks.jsx`, `TaskSidePanel.jsx`, `Checklist.jsx`, `TaskList.jsx`, `EventsCalendar.jsx`, `LongTermTasksGantt.jsx`, `CalendarSync.jsx`, `TaskEventBridge.jsx`, `TaskNotificationWatcher.jsx`, `TasksRefactored.jsx`, hook `useWeddingTasksHierarchy.js`, utilidades `taskAutomations`, `CalendarComponents.jsx`, plantilla `apps/main-app/src/data/tasks/masterTimelineTemplate.json`, indicadores de riesgo en el Gantt y comentarios colaborativos con menciones y notificaciones en `TaskSidePanel.jsx`.
- **[pendiente (doc)]**
  - Motor IA que personaliza un plan de tareas padre/subtareas a partir de una plantilla maestra y matriz de responsabilidades (y una `SmartChecklist`/asistente).
- **[E2E specs]** 1/1 presentes
...
- **[verificacion de archivos implementados]**
  ...
  - `apps/main-app/src/pages/Checklist.jsx` (y `apps/main-app/src/pages/protocolo/Checklist.jsx`)
