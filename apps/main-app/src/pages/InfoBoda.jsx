          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 border-b-2">
              <button
                ...
                style={{
                  backgroundColor:
                    activeTab === 'info' ? 'var(--color-primary)' : 'var(--color-surface)',
              ...
              <button
                ...
                style={{
                  backgroundColor:
                    activeTab === 'vision' ? 'var(--color-lavender)' : 'var(--color-surface)',
                  color:
                    activeTab === 'vision' ? 'var(--color-text)' : 'var(--color-text-secondary)',
                  borderRadius: 'var(--radius-md) var(--radius-md) 0 0',
              ...
              <button
                ...
                style={{
                  backgroundColor:
                    activeTab === 'suppliers' ? 'var(--color-sage)' : 'var(--color-surface)',
                  color:
                    activeTab === 'suppliers' ? 'var(--color-text)' : 'var(--color-text-secondary)',
                  borderRadius: 'var(--radius-md) var(--radius-md) 0 0',
                  border: `1px solid ${activeTab === 'suppliers' ? 'var(--color-sage)' : 'var(--color-border-soft)'}`,
                  borderBottom: 'none',
                  boxShadow:
                    activeTab === 'suppliers' ? '0 2px 8px rgba(205, 234, 192, 0.4)' : 'none',
                }}
              >
              ...
              <button
                ...
                style={{
                  backgroundColor:
                    activeTab === 'images' ? 'var(--color-pink)' : 'var(--color-surface)',
                  color:
                    activeTab === 'images' ? 'var(--color-text)' : 'var(--color-text-secondary)',
                  borderRadius: 'var(--radius-md) var(--radius-md) 0 0',
              ...
              <>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm " style={{ color: 'var(--color-text-secondary)' }}>
                          Completa todos los datos de tu boda
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h2 className="text-xl font-bold " style={{ color: 'var(--color-text)' }}>
                        {t('infoBoda.vision.title')}
                      </h2>
                      <p className="text-sm " style={{ color: 'var(--color-text-secondary)' }}>
                        {t('infoBoda.vision.subtitle')}
                      </p>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full min-h-[80px] px-3 py-2 border  rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        style={{ borderColor: 'var(--color-border)' }}
                      />
                    </div>
                    <div>
                ...
                <Card className="bg-gradient-to-r from-pink-50 to-purple-50 border-2 border-pink-200">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h2 className="text-xl font-bold " style={{ color: 'var(--color-text)' }}>
                        {t('infoBoda.essential.title')}
                      </h2>
                      <p className="text-sm " style={{ color: 'var(--color-text-secondary)' }}>
                        {t('infoBoda.essential.subtitle')}
                      </p>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-xs  mt-1" style={{ color: 'var(--color-muted)' }}>
                        {t('infoBoda.essential.coupleNameHint')}
                      </p>
                    </div>
                    <Input
                ...
                <Card className="border-l-4 border-l-blue-500">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm " style={{ color: 'var(--color-text-secondary)' }}>
                        Dónde y cómo será vuestra boda
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <label
                            ...
                            style={{ color: 'var(--color-text)' }}
                          >
                            <span className="" style={{ color: 'var(--color-danger)' }}>
                              *
                            </span>
                            Tipo de ceremonia
                          </label>
                      ...
                      {weddingInfo.ceremonyType === 'religiosa' && (
                        ...
                        >
                          💡 <strong>Consejo:</strong> Tramita los papeles en la parroquia con 6
                          meses de antelación. Algunos ritos requieren cursillos prematrimoniales.
                        </div>
                      )}
                      {weddingInfo.ceremonyType === 'civil' && (
                        ...
                        >
                          💡 <strong>Consejo:</strong> Reserva el lugar (juzgado, ayuntamiento o
                          finca) con 3-4 meses de antelación.
                        </div>
                      )}
                      {weddingInfo.ceremonyType === 'simbolica' && (
                        ...
                        >
                          💡 <strong>Consejo:</strong> Las ceremonias simbólicas permiten total
                          personalización. Considera contratar un oficiante profesional.
                        </div>
                      )}
                    </div>
                ...
                <Card className="border-l-4 border-l-green-500">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h2 className="text-xl font-bold " style={{ color: 'var(--color-text)' }}>
                        {t('infoBoda.experience.title')}
                      </h2>
                      <p className="text-sm " style={{ color: 'var(--color-text-secondary)' }}>
                        {t('infoBoda.experience.subtitle')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                          ...
                          <>
                            ...
                            <div className="ml-6">
                              ...
                              <textarea
                                ...
                                className="w-full min-h-[60px] px-3 py-2 border  rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                style={{ borderColor: 'var(--color-border)' }}
                              />
                            </div>
                          </>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 border  rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent mb-2"
                            style={{ borderColor: 'var(--color-border)' }}
                          />
                          <input
                            type="tel"
                    ...
                    <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
                      ...
                      <textarea
                        ...
                        onChange={handleWeddingChange}
                        placeholder="Entrantes:&#10;- Ensalada...&#10;&#10;Principales:&#10;- Solomillo..."
                        className="w-full min-h-[100px] px-3 py-2 border  rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                        style={{ borderColor: 'var(--color-border)' }}
                      />
                    </div>
                  </div>
                ...
                <Card className="border-l-4 border-l-purple-500">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm " style={{ color: 'var(--color-text-secondary)' }}>
                        Detalles visuales de vuestra boda
                      </p>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Card className="border-l-4 border-l-orange-500">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm " style={{ color: 'var(--color-text-secondary)' }}>
                        Transporte, alojamiento y facilidades
                      </p>
                    </div>
                  </div>
                  <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            className="w-full min-h-[60px] px-3 py-2 border  rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                            style={{ borderColor: 'var(--color-border)' }}
                          />
                        </div>
                      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        {weddingInfo.giftAccount && (
                          <div className="absolute right-3 top-2.5">
                            {ibanError ? (
                              <span className=" text-xl" style={{ color: 'var(--color-danger)' }}>
                                ❌
                              </span>
                            ) : (
                      ...
                      <p className="mt-1 text-xs " style={{ color: 'var(--color-muted)' }}>
                        Este IBAN aparecerá en las invitaciones y en la web para que los invitados
                        puedan enviar regalos
                      </p>
                    </div>
                    <div className="border-t pt-4 mt-4">
                      <h3
