    ...
    try {
      const response = await fetch(`${getBackendUrl()}/api/quote-validation/manual-example`, {
        ...
        body: JSON.stringify({
          ...
          adminUserId: currentUser?.uid || currentUser?.id || 'unknown',
        }),
      });
      ...
      {showAddForm && (
        <Card className="p-6 mb-8 border-2 border-blue-200">
          <h3 className="text-xl font-bold  mb-4 flex items-center gap-2" className="text-body">
            <FileText className="w-5 h-5 " className="text-primary" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border  rounded-lg focus:ring-2 focus:ring-blue-500" className="border-default"
                  required
                >
