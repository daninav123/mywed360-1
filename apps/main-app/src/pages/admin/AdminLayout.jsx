    ...
    <div className="min-h-screen bg-[var(--color-bg)] text-[color:var(--color-text)]">
      <div className="relative flex min-h-screen">
        ...
        >
          {!sidebarCollapsed && (
            <div className="flex h-full flex-col">
              ...
              <nav className="flex-1 overflow-y-auto px-4 py-6 space-y-6">
                {ADMIN_NAVIGATION.map((section) => (
                  <div key={section.title}>
                    <p className="px-2 text-xs uppercase tracking-wide text-[color:var(--color-text-soft)] mb-2">
                      {section.title}
                    </p>
                      ...
                      {section.items.map((item) => (
                        <li key={item.path}>
                          <NavLink
                            ...
                            className={({ isActive }) =>
                              isActive
                                ? 'block rounded-md px-3 py-2 text-sm transition-colors bg-[color:var(--color-primary)] text-[color:var(--color-on-primary)]'
                                : 'block rounded-md px-3 py-2 text-sm transition-colors text-[color:var(--color-text)] hover:bg-[var(--color-bg-soft)]'
                            }
                          >
                            {item.label}
                          </NavLink>
              ...
              <div className="px-6 py-4 border-t border-soft text-xs text-[color:var(--color-text-soft)] space-y-1">
        ...
        <button
          ...
          className="hidden lg:flex items-center justify-center absolute top-6 z-20 h-10 w-10 rounded-full border border-soft bg-surface text-[color:var(--color-text)] shadow-sm transition-all hover:bg-[var(--color-bg-soft)] transform -translate-x-1/2"
          ...
          <header className="border-b border-soft bg-surface">
            <div className="flex flex-col gap-4 px-6 py-4 lg:flex-row lg:items-center lg:justify-between">
              <div className="space-y-2">
                ...
                <div
                  className="text-xs text-[color:var(--color-text-soft)]"
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                <span className="flex flex-col text-right text-xs text-[color:var(--color-text-soft)]">
                ...
                <button
                  ...
                  className="rounded-md border border-soft px-3 py-2 text-sm font-medium text-[color:var(--color-primary)] hover:bg-[var(--color-bg-soft)]"
                >
                  Ayuda
                </button>
                <button
                  ...
                  className="rounded-md border border-soft px-3 py-2 text-sm font-medium text-[color:var(--color-text)] hover:bg-[var(--color-bg-soft)]"
                >
                  Cerrar sesion
                </button>
              </div>
          ...
          <div className="w-full max-w-sm rounded-xl bg-surface p-6 shadow-xl space-y-4">
            ...
            <div className="flex flex-col gap-2 text-sm">
              <a
                ...
                className="rounded-md border border-soft px-3 py-2 text-center hover:bg-[var(--color-bg-soft)]"
              >
                Contactar por email
              </a>
              <a
