...
export default function CanvasToolbar({ canvasRef, canvasSize, onSizeChange }) {
  ...
  return (
    <div className=" border-b  px-4 py-2 flex items-center gap-4" className="border-default" className="bg-surface">
      ...
      <div className="ml-auto text-xs " className="text-muted">
