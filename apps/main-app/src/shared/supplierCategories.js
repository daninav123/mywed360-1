...
export const SUPPLIER_CATEGORIES = [
  ...
  },
  {
    ...
    googlePlacesType: 'night_club', // Músicos suelen estar en lugares de eventos
    keywords: ['musica', 'musico', 'banda', 'orquesta', 'grupo musical', 'sonido', 'audio', 'sound', 'music', 'alquiler sonido', 'alquiler audio', 'equipos sonido', 'equipos audio', 'musica bodas', 'musicos boda', 'orquesta boda'],
    coverage: 'medium',
  },
  {
    id: 'dj',
