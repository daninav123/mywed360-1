...
export default function GuestListCard({ confirmed, pending }) {
  ...
  return (
    <MetricCard
      title={t('home2.guestList.title', { defaultValue: 'Guest List' })}
      bgColor="#FCE4EC"
      textColor="#C97C8F"
      valueColor="#C97C8F"
      accentColor="#C97C8F"
    >
      <div className="flex items-baseline gap-2">
        ...
        <p className="text-sm opacity-70" style={{ color: '#718096' }}>
          {t('home2.guestList.confirmed', { defaultValue: 'Confirmed' })}
        </p>
      </div>
      <p className="text-xs opacity-70 mt-1" style={{ color: '#718096' }}>
        {pendingCount} {t('home2.guestList.pending', { defaultValue: 'Pending' })}
      </p>
    </MetricCard>
  );
}
