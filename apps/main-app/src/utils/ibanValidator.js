...
export function getIBANCountry(iban) {
  ...
  const countries = {
    AD: 'Andorra', AE: 'Emiratos Árabes Unidos', AL: 'Albania', AT: 'Austria',
    AZ: 'Azerbaiyán', BA: 'Bosnia y Herzegovina', BE: 'Bélgica', BG: 'Bulgaria',
    BH: 'Bahréin', BR: 'Brasil', CH: 'Suiza', CR: 'Costa Rica', CY: 'Chipre',
    CZ: 'República Checa', DE: 'Alemania', DK: 'Dinamarca', DO: 'República Dominicana',
    EE: 'Estonia', ES: 'España', FI: 'Finlandia', FO: 'Islas Feroe', FR: 'Francia',
    GB: 'Reino Unido', GE: 'Georgia', GI: 'Gibraltar', GL: 'Groenlandia', GR: 'Grecia',
    GT: 'Guatemala', HR: 'Croacia', HU: 'Hungría', IE: 'Irlanda', IL: 'Israel',
    IS: 'Islandia', IT: 'Italia', JO: 'Jordania', KW: 'Kuwait', KZ: 'Kazajistán',
    LB: 'Líbano', LI: 'Liechtenstein', LT: 'Lituania', LU: 'Luxemburgo', LV: 'Letonia',
    MC: 'Mónaco', MD: 'Moldavia', ME: 'Montenegro', MK: 'Macedonia del Norte',
    MR: 'Mauritania', MT: 'Malta', MU: 'Mauricio', NL: 'Países Bajos', NO: 'Noruega',
    PK: 'Pakistán', PL: 'Polonia', PS: 'Palestina', PT: 'Portugal', QA: 'Catar',
    RO: 'Rumania', RS: 'Serbia', SA: 'Arabia Saudita', SE: 'Suecia', SI: 'Eslovenia',
    SK: 'Eslovaquia', SM: 'San Marino', TN: 'Túnez', TR: 'Turquía', UA: 'Ucrania',
    VA: 'Ciudad del Vaticano', VG: 'Islas Vírgenes Británicas', XK: 'Kosovo'
  };
