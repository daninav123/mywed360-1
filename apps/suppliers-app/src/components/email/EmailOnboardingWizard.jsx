  ...
  const validateDNS = async () => {
    ...
    try {
      ...
      setValidation({
        ...
        loading: false,
        errors:
          !dkimValid || !spfValid ? [tEmail('onboarding.validation.errors.recordsMissing')] : [],
      });
    } catch (error) {
      setValidation({
        dkim: 'error',
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={tEmail('onboarding.domain.fields.fromEmail.placeholder')}
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={tEmail('onboarding.domain.fields.fromName.placeholder')}
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={tEmail('onboarding.domain.fields.replyTo.placeholder')}
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700"
                    />
                  </div>
                </div>
