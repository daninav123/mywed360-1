...
describe('Flujo de envío de correos desde búsqueda AI de proveedores (CP-EP-07)', () => {
  beforeEach(() => {
    ...
    cy.window().then((win) => {
      win.localStorage.setItem('userEmail', 'usuario.test@maloveapp.com');
    ...
    win.localStorage.setItem('maloveapp_active_wedding', 'test-wedding-123');
    win.localStorage.setItem('maloveapp_active_wedding', 'test-wedding-123');
    const mockWedding = {
      id: 'test-wedding-123',
    ...
    win.localStorage.setItem('maloveapp_wedding_test-wedding-123', JSON.stringify(mockWedding));
    win.localStorage.setItem('maloveapp_wedding_test-wedding-123', JSON.stringify(mockWedding));
    const mockProfile = {
      uid: 'cypress-ai-user',
    ...
    win.localStorage.setItem('maloveapp_user', JSON.stringify(mockProfile));
    win.localStorage.setItem('maloveapp_user', JSON.stringify(mockProfile));
    win.localStorage.setItem('maloveapp_login_email', 'usuario.test@maloveapp.com');
