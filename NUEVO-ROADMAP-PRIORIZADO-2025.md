...
- ⚠️ **Tests bloqueados:** 3 unitarios bloquean 13+ E2E
- ⚠️ **50+ tests E2E fallando**
- ✅ **Core funcional:** Seating, Email, Finance, Invitados (con issues)
...
#### **Por qué es urgente:**
- 3 tests unitarios bloquean 13+ tests E2E de seating
- Sin tests estables, no hay confianza para deployar
- Bloquea todo el flujo de CI/CD

#### **Tareas:**
1. ✅ Arreglar `unit_rules`, `unit_rules_exhaustive`, `unit_rules_extended`
2. ✅ Desbloquear 13 tests E2E de seating
3. ✅ Reparar 7 tests E2E de email
4. ✅ Reparar tests críticos: `rsvp_confirm_by_token`, `budget_flow`, `guests_flow`
5. ✅ Estabilizar seeds y fixtures
...
- Tests bloqueados pueden tener issues de infraestructura
