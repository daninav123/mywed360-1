...
- `mywed360-v*` → `maloveapp-v*`
- `mywed360-static` → `maloveapp-static`
- `mywed360-dynamic` → `maloveapp-dynamic`
- `mywed360-api` → `maloveapp-api`
- `mywed360-share-target` → `maloveapp-share-target`

### 8. Configuraciones de Firebase

- `mywed360-test*` → `maloveapp-test*`
- `us-central1-mywed360` → `us-central1-maloveapp`
...
- `branding: 'mywed360'` → `branding: 'maloveapp'`
...
```javascript
// Antes
localStorage.getItem('mywed360_user_session')
