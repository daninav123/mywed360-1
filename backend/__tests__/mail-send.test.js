...
vi.mock('../middleware/authMiddleware.js', () => ({
  __esModule: true,
  requireAuth: () => (req, _res, next) => { req.user = { uid: 'u1' }; req.userProfile = { email: 'user@example.com', myWed360Email: 'user@maloveapp.com', role: 'admin' }; next(); },
  requireMailAccess: () => (req, _res, next) => { req.user = { uid: 'u1' }; req.userProfile = { email: 'user@example.com', myWed360Email: 'user@maloveapp.com', role: 'admin' }; next(); },
