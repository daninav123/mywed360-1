...
router.post('/register', async (req, res) => {
  try {
    const { email, password, name, category, location, phone, website, description } = req.body;
    ...
    // 2. Buscar si ya existe un perfil "cached" con ese email
    // ⚠️ NOTA: Ya no creamos perfiles "discovered" por implicaciones legales
