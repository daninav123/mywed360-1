    ...
    ceremonia: [
      {
        ...
        tempo: 'lento',
        era: '2010s',
        tags: ['entrada novia', 'moderna'],
        reason: 'Balada emotiva y popular para entrada de la novia.',
      },
      {
        title: 'Canon in D',
        artist: 'Pachelbel',
        ...
        tempo: 'lento',
        era: 'barroco',
        tags: ['procesional', 'clásica'],
        reason: 'Clásico atemporal para procesional y momentos solemnes.',
      },
      {
        title: 'Perfect',
        artist: 'Ed Sheeran',
        ...
        tempo: 'medio',
        era: '2010s',
        tags: ['entrada', 'moderna'],
        reason: 'Letra romántica ideal para entrada o intercambio de anillos.',
      },
    ],
    coctail: [
      {
        ...
        era: '60s',
        tags: ['jazz', 'chill'],
        reason: 'Clásico suave para ambiente de cóctel.',
      },
      {
        ...
        era: '2000s',
        tags: ['soul', 'acústico'],
        reason: 'Vibra cálida y agradable para recibir a los invitados.',
      },
    ],
    banquete: [
      {
        ...
        tempo: 'rápido',
        era: '2010s',
        tags: ['entrada salón', 'celebración'],
        reason: 'Energía festiva para entrada de los novios al salón.',
      },
      {
        title: 'Sugar',
        artist: 'Maroon 5',
        ...
        tempo: 'rápido',
        era: '2010s',
        tags: ['corte de tarta', 'pop'],
        reason: 'Pop animado que funciona muy bien con momentos señalados.',
      },
    ],
    disco: [
      {
        ...
        tempo: 'lento',
        era: '2010s',
        tags: ['primer baile', 'balada'],
        reason: 'Favorito para primer baile por su ritmo y letra.',
      },
      {
        title: 'Danza Kuduro',
        artist: 'Don Omar',
        ...
        tempo: 'rápido',
        era: '2010s',
        tags: ['abrir pista', 'latino'],
        reason: 'Abre y mantiene la pista llena al instante.',
      },
    ],
  };
  ...
  try {
      ...
      songs: [
        {
          ...
          era: '1990s|2000s|2010s|classic',
          tags: ['primer baile', 'entrada', 'salida'],
        },
      ],
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: `${sys} Devuelve exactamente ${JSON.stringify(schemaHint)} con entre 6 y 12 canciones.`,
        },
