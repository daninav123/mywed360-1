 ...
 */
router.get('/weddings/:weddingId/services', authenticateToken, async (req, res) => {
  try {
 ...
 */
router.post(
  '/weddings/:weddingId/services/:serviceId/assign',
  authenticateToken,
  async (req, res) => {
    try {
 ...
 */
router.put(
  '/weddings/:weddingId/services/:serviceId/status',
  authenticateToken,
  async (req, res) => {
    try {
      const { weddingId, serviceId } = req.params;
 ...
 */
router.post(
  '/weddings/:weddingId/services/:serviceId/payments',
  authenticateToken,
  async (req, res) => {
    try {
      const { weddingId, serviceId } = req.params;
