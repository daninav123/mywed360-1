...
const AppOverview = () => {
  return (
    <MarketingLayout>
      <section className="rounded-3xl border border-soft bg-surface/90 p-10 shadow-lg shadow-[var(--color-primary)]/15">
        <div className="grid gap-10 lg:grid-cols-[1.6fr,1fr] lg:items-start">
          <div>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
              {stats.map((item) => (
                <div
                  key={item.label}
                  className="rounded-2xl border border-[var(--color-primary)]/35 bg-primary-soft p-4 text-body"
                >
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[var(--color-primary)]/45 bg-[var(--color-primary)] p-8 text-white">
      ...
      <section className="mt-16">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          {modules.map((module) => (
            <article
              key={module.title}
              className="rounded-2xl border border-soft bg-surface/85 p-6 shadow-sm shadow-[var(--color-primary)]/10 transition-shadow hover:shadow-md hover:shadow-[var(--color-primary)]/20"
            >
      ...
      <section className="mt-16 rounded-3xl border border-soft bg-surface/90 p-10 shadow-lg shadow-[var(--color-primary)]/15">
        <div className="grid gap-8 md:grid-cols-[1.4fr,0.6fr] md:items-center">
          ...
          <div className="rounded-2xl border border-[var(--color-primary)]/35 bg-primary-soft p-6">
