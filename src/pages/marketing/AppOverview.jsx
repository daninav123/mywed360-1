...
const AppOverview = () => {
  return (
    <>
      <Helmet>
        <title>MaLove.App | Plataforma para planificar bodas de principio a fin</title>
        <meta
          name="description"
          content="Coordina tareas, proveedores, finanzas y la experiencia de invitados con MaLove.App, la solución integral para wedding planners y parejas."
        />
        <link rel="canonical" href="https://malove.app/app" />
        <meta
          property="og:title"
          content="MaLove.App | Plataforma para planificar bodas de principio a fin"
        />
        <meta
          property="og:description"
          content="Centraliza checklists, presupuestos, invitados y automatizaciones desde un solo workspace."
        />
        <meta property="og:url" content="https://malove.app/app" />
        ...
        <meta
          ...
          content="Organiza cada fase del evento con herramientas conectadas para planners y parejas."
        />
        <meta name="twitter:image" content="https://malove.app/maloveapp-logo.png" />
        <script type="application/ld+json">{JSON.stringify(overviewStructuredData)}</script>
      </Helmet>
          ...
          <div className="grid gap-8 md:grid-cols-[1.4fr,0.6fr] md:items-center">
            <div>
              ...
              <p className="mt-4 text-base text-muted">
                Conecta MaLove.App con servicios de pago, calendarios y herramientas de
                comunicacion. Configura disparadores automaticos para RSVP, confirmaciones de
                proveedores o seguimiento de tareas.
              </p>
