...
const ForSuppliers = () => {
  ...
  const supplierStructuredData = useMemo(
    () => ({
  ...
  return (
    <>
      <Helmet>
        <title>MaLove.App para proveedores | Consigue parejas cualificadas</title>
        <meta
          name="description"
          content="Crea tu portafolio en MaLove.App, llega a parejas en tu zona y recibe solicitudes cualificadas con métricas y mensajería centralizadas."
        />
        <link rel="canonical" href="https://malove.app/para-proveedores" />
        <meta
          property="og:title"
          content="MaLove.App para proveedores | Consigue parejas cualificadas"
        />
        <meta
          property="og:description"
          content="Gestiona tu presencia, paga solo por visualizaciones y convierte parejas en clientes con herramientas profesionales."
        />
        <meta property="og:url" content="https://malove.app/para-proveedores" />
        ...
        <meta
          ...
          content="Destaca tu negocio de bodas, recibe leads cualificados y obtén estadísticas en tiempo real."
        />
        <meta name="twitter:image" content="https://malove.app/maloveapp-logo.png" />
        <script type="application/ld+json">{JSON.stringify(supplierStructuredData)}</script>
      </Helmet>
        ...
        <section className="layout-container grid gap-12 rounded-3xl border border-soft bg-white/95 px-6 py-10 shadow-lg shadow-[var(--color-primary)]/15 lg:grid-cols-[1.15fr,0.85fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-muted">
              MaLove.App te ayuda a llegar a miles de parejas organizando su boda. Sistema de pago
              por visualización sin suscripciones mensuales ni comisiones por contrato.
            </p>
            <p className="mt-3 text-lg text-muted">
              Crea tu portafolio profesional, recibe solicitudes cualificadas y gestiona todo desde
              tu dashboard.
            </p>
        ...
        <section className="layout-container mt-24 grid gap-10 rounded-3xl border border-soft bg-white/95 px-6 py-10 shadow-lg shadow-[var(--color-primary)]/15 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-soft bg-white/95 p-8 shadow-lg shadow-[var(--color-primary)]/15">
            ...
            <p className="mt-3 text-sm text-muted">
              Completa este formulario y nuestro equipo se pondrá en contacto contigo para
          ...
          <div className="grid gap-10 md:grid-cols-[2fr,1fr] md:items-center">
            <div>
              <h2 className="text-3xl font-semibold">
                Empieza a recibir solicitudes de parejas hoy
              </h2>
