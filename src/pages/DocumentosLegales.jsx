  ...
  return (
    <div className="p-4 md:p-6 max-w-3xl mx-auto">
      <Card className="p-6 space-y-4">
        <h1 className="text-2xl font-bold">Generador de Documentos Legales (MVP)</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium mb-1">Tipo</label>
            <select name="tipo" value={form.tipo} onChange={onChange} className="w-full border rounded px-3 py-2">
              <option value="consentimiento_imagen">Consentimiento de uso de imagen</option>
            </select>
          </div>
          <div>
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Nombre de los novios</label>
            <input name="nombreNovios" value={form.nombreNovios} onChange={onChange} className="w-full border rounded px-3 py-2" />
          </div>
          <div className="md:col-span-2">
            <label className="block text-sm font-medium mb-1">Nombre del tercero</label>
            <input name="nombreTercero" value={form.nombreTercero} onChange={onChange} className="w-full border rounded px-3 py-2" />
          </div>
        </div>
