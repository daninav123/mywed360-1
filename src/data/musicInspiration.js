...
export const MUSIC_INSPIRATION = {
  ceremonia: {
    'Entrada novia': [
      ...
      { title: 'All of Me', artist: 'John Legend', tags: ['romántica'] },
      { title: 'Canon in D', artist: 'Pachelbel', tags: ['clásica'] },
      { title: 'River Flows in You', artist: 'Yiruma', tags: ['piano','instrumental'] },
      { title: 'Bridal Chorus', artist: 'Wagner', tags: ['clásica'] },
      { title: 'Perfect', artist: 'Ed Sheeran', tags: ['romántica'] }
    ],
    'Entrada novio': [
      { title: 'Here Comes the Sun', artist: 'The Beatles', tags: ['clásico','feliz'] },
    ...
    'Intercambio de anillos': [
      { title: 'La Vie en Rose', artist: 'Édith Piaf', tags: ['clásico','romántico'] },
      { title: 'Hallelujah', artist: 'Jeff Buckley', tags: ['emocional'] },
      { title: 'Turning Page', artist: 'Sleeping at Last', tags: ['balada'] }
    ],
    'Salida': [
      { title: 'Signed, Sealed, Delivered (I’m Yours)', artist: 'Stevie Wonder', tags: ['fiesta','soul'] },
  ...
  coctail: {
    'Chill/Jazz': [
      ...
      { title: 'L-O-V-E', artist: 'Nat King Cole', tags: ['jazz','clásico'] },
      { title: 'Sway', artist: 'Michael Bublé', tags: ['latin jazz'] }
    ],
    'Acústico/Indie': [
      { title: 'Put Your Records On', artist: 'Corinne Bailey Rae', tags: ['soul'] },
      { title: 'Budapest', artist: 'George Ezra', tags: ['indie'] },
      { title: 'Better Together', artist: 'Jack Johnson', tags: ['acústico'] }
    ],
    'Versiones modernas': [
      { title: 'Can’t Help Falling in Love', artist: 'Kina Grannis (cover)', tags: ['cover','suave'] },
      { title: 'Stand by Me', artist: 'Boyce Avenue (cover)', tags: ['cover','acústico'] }
    ]
  },
  banquete: {
    'Entrada al salón': [
      { title: 'Marry You', artist: 'Bruno Mars', tags: ['celebración'] },
      { title: 'I Gotta Feeling', artist: 'Black Eyed Peas', tags: ['fiesta'] },
      { title: 'Crazy in Love', artist: 'Beyoncé', tags: ['energía'] }
    ],
    'Corte de tarta': [
      { title: 'Sugar', artist: 'Maroon 5', tags: ['pop'] },
      { title: 'Love on Top', artist: 'Beyoncé', tags: ['feliz'] },
      { title: 'How Sweet It Is', artist: 'James Taylor', tags: ['clásico'] }
    ],
    'Lanzamiento de ramo': [
      { title: 'Single Ladies', artist: 'Beyoncé', tags: ['icónica'] },
  ...
  disco: {
    'Primer baile': [
      ...
      { title: 'Can’t Help Falling in Love', artist: 'Elvis Presley', tags: ['clásico'] },
    ...
    'Clásicos infalibles': [
      ...
      { title: 'Don’t Stop Me Now', artist: 'Queen', tags: ['rock','energía'] }
    ]
  }
};
