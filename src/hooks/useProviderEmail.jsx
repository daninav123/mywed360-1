 ...
 * emails a proveedores utilizando el sistema de correo personalizado de MaLoveApp.
 *
...
export const useProviderEmail = () => {
  ...
  const generateDefaultEmailBody = useCallback(
    (provider) => {
      ...
      <p style="color:#888; font-size:12px;">Email enviado desde MaLoveApp - Tu plataforma para organización de bodas</p>
    `;
    },
    [profile, weddingDoc]
  );
