...
const parents = [
  ...
  {
    id: 'anillos-luna-miel',
    title: 'Anillos y Luna de Miel',
    category: 'ANILLOS_Y_VIAJE',
    phaseStartPct: 70,
    phaseEndPct: 100,
    startOffsetDays: -50,
    durationDays: 120,
    children: [
      { id: 'comprar-anillos', title: 'Comprar anillos (recoger justo antes)', startOffsetDays: -45, durationDays: 30 },
      { id: 'planificar-luna-miel', title: 'Planificar luna de miel (elecci?n, reservas, maletas)', startOffsetDays: -40, durationDays: 60 },
    ],
  },
  {
    id: 'despues-boda',
