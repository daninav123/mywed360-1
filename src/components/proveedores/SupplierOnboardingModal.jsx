    ...
    return {
      couple:
        [weddingInfo.brideFirstName, weddingInfo.groomFirstName, weddingInfo.partnerFirstName]
          .filter(Boolean)
          .join(" & ") || weddingInfo.title || weddingInfo.name,
      date: formattedDate,
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600">
            {[0, 1, 2].map((index) => (
              <React.Fragment key={index}>
                ...
                {index < 2 && <span className={`h-px flex-1 ${step > index ? "bg-blue-400" : "bg-gray-200"}`} />}
              </React.Fragment>
            ))}
          </div>
        </div>
          ...
          {step === 0 && (
            <div className="space-y-4">
              ...
              <p className="text-gray-600">
                Te acompanaremos para seleccionar los servicios esenciales y crear tarjetas iniciales con estado "Pendiente". Podras ajustarlo
                mas adelante desde "Configurar servicios".
              </p>
              {loadingWedding ? (
                ...
                <div className="rounded-lg border border-blue-100 bg-blue-50 p-4 text-sm text-blue-800">
                  ...
                  <ul className="mt-1 space-y-1">
                    ...
                    {weddingSummary.budget && <li>Presupuesto estimado: {weddingSummary.budget} EUR</li>}
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 text-sm text-gray-600">
                  ...
                  <p className="mt-1">Puedes completarlos mas adelante desde la ficha de la boda.</p>
                </div>
              )}
          ...
          {step === 1 && (
            <div className="space-y-5">
              <div>
                ...
                <p className="text-gray-600">Puedes marcar y desmarcar libremente. Anade otros servicios al final si lo necesitas.</p>
              </div>

              <div className="space-y-4">
                {suggestedGroups.map((group) => (
                  <div key={group.title}>
                    <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-gray-500">{group.title}</p>
          ...
          {step === 2 && (
            <div className="space-y-5">
              <div>
                ...
                <p className="text-gray-600">
                  Crearemos tarjetas "Pendiente" para estos servicios y activaremos sugerencias basadas en IA para ayudarte a encontrarlos.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {summaryLabels.map((item) => (
                    <span key={item} className="rounded-full bg-white px-3 py-1 text-sm text-gray-700 border border-gray-300">
                      {item}
                    </span>
                  ))}
                </div>
              ...
              <div className="rounded-lg border border-blue-100 bg-blue-50 p-4 text-sm text-blue-800">
                ...
                <ul className="mt-1 space-y-1 list-disc pl-5">
                  <li>Guardaremos los servicios seleccionados con estado "Pendiente" en la boda activa.</li>
                  <li>Las tarjetas apareceran al inicio del dashboard para priorizar su contratacion.</li>
                  <li>Podras ajustar prioridades y filtros desde "Configurar servicios" en cualquier momento.</li>
                </ul>
              </div>
            </div>
          )}
