...
import { addTagToEmail, removeTagFromEmail, getEmailTagsDetails, getUserTags } from '../../services/tagService';
import { updateMailTags } from '../../services/emailService';

export default function MailViewer({ mail, onMarkRead, onDelete, onCompose, folders = [], onMoveToFolder = () => {}, userId = null }) {
  const replyInitial = () => ({
  ...
  const handleMark = () => { onMarkRead && onMarkRead(mail); };
  const handleDelete = () => {
