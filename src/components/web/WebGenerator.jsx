...
const WebGenerator = ({
  ...
  <div className="bg-white rounded-lg shadow p-6 mb-8">
    ...
    <p className="text-gray-600 mb-4">
      ...
      {selectedTemplate !== 'personalizada' && templates?.[selectedTemplate] && (
        <span className="block mt-2 text-blue-600">
          Usando plantilla: <strong>{templates[selectedTemplate].name}</strong>. Puedes modificar el
          texto sugerido o añadir más detalles.
        </span>
      )}
    </p>
    ...
    <textarea
      ...
      placeholder={t('common.describe_como_quieres_que_sea')}
      value={prompt}
