...
import { CheckCircle, Search, Clock, Phone, Mail, ExternalLink, MessageCircle } from 'lucide-react';
 ...
 */
export default function WeddingServiceCard({ service, confirmedProvider, shortlistCount = 0, onSearch }) {
      ...
      {hasConfirmed ? (
        ...
        <div className="space-y-3">
          <div className="border-l-4 border-green-500 bg-green-50 p-3 rounded">
            ...
            {confirmedProvider.contact && (
              <p className="text-sm text-gray-600 mt-1">
                Contacto: {confirmedProvider.contact}
              </p>
            )}
              ...
              <div className="flex items-center gap-1 mt-1 text-sm">
                ...
                {confirmedProvider.ratingCount > 0 && (
                  <span className="text-gray-500">
                    ({confirmedProvider.ratingCount} reseñas)
                  </span>
                )}
              </div>
            )}
          ...
          <div className="flex gap-2">
            {confirmedProvider.phone && (
              <button
                onClick={() => window.open(`https://wa.me/${confirmedProvider.phone.replace(/\D/g, '')}`, '_blank')}
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <Search size={16} />
              {hasShortlist ? 'Buscar más' : 'Buscar proveedores'}
            </button>
          </div>
