  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-[var(--color-surface)]/80 backdrop-blur-md border-soft">
        ...
        {onUpdateSettings && (
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-sm text-[color:var(--color-text)]/70 mb-1">
                {t('finance.budget.thresholds.danger', { defaultValue: 'Crï¿½tico (exceso) %' })}
              </label>
              <input
                type="number"
                min="0"
      ...
      <Card className="overflow-hidden bg-[var(--color-surface)]/80 backdrop-blur-md border-soft">
        ...
        {budgetUsage.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <Button leftIcon={<Plus size={16} />} onClick={handleAddCategory}>
              {t('finance.budget.createFirst', { defaultValue: 'Crear primera categorï¿½a' })}
            </Button>
          </div>
        ) : (
      ...
      <Modal
        ...
        title={
          editingCategory
            ? t('finance.budget.modal.editTitle', { defaultValue: 'Editar categorï¿½a' })
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-[color:var(--color-text)]/80 mb-1">
              {t('finance.budget.modal.name', { defaultValue: 'Nombre de la categorï¿½a' })}
            </label>
            <input
              type="text"
          ...
          <div className="flex justify-end space-x-3 pt-4">
            ...
            <Button onClick={handleSaveCategory}>
              ...
              {t('finance.budget.category', { defaultValue: 'categorï¿½a' })}
            </Button>
          </div>
        </div>
      </Modal>
